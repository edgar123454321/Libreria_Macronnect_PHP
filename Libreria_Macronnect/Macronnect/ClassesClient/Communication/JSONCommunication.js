...
export class JSONCommunication {
    ...
    static validResponse(_response) {
        ...
        try {
            ...
            throw new GeneralError("Error Parse JSON", "Error al Convertir la Siguiente Respuesta a JSON: " + _response);
        }
        if (response["Status"] == "Error") {
            ...
            throw new GeneralError(response["TypeError"], response["MessageError"]);
        }
        return response;
    }
