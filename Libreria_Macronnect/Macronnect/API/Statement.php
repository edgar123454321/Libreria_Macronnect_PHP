<?php 
    ...
    class Statement {
        ...
        public function getToken(): string {
            ...
            $dsn = "mysql:host=" . DataConnection_Sisga::$HOST . ";dbname=" . DataConnection_Sisga::$BDNAME . ";charset=utf8mb4";

            try {
                $pdo = new PDO($dsn, DataConnection_Sisga::$USUARIO, DataConnection_Sisga::$PASSWORD);
