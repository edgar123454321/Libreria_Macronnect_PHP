<?php 
    ...
    // URL Endpoint
    $dataEndpoint = new DataEndpoint("/inventarios/articulos/precio");

    // Values Endpoint
    $dataEndpoint->setTitle("Simulacion Modulo Facturacion - Precio Articulo");
    $dataEndpoint->setMethod("GET");
    $dataEndpoint->setVersionAPI(DataConnection::$PATH_VERSION_API_CLIENT);
    $dataEndpoint->setDescription("Este Endpoint Consulta el Precio de un Articulo. Similar a como funciona el Modulo de Facturacion al Cargar un Articulo.");
