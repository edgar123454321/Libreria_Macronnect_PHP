<?php 
    ...
    // URL Endpoint
    $dataEndpoint = new DataEndpoint("/inventarios/existencias/");

    // Values Endpoint
    $dataEndpoint->setTitle("Existencias Articulo");
    $dataEndpoint->setMethod("GET");
    $dataEndpoint->setVersionAPI(DataConnection::$PATH_VERSION_API_CLIENT);
    $dataEndpoint->setDescription("Este Endpoint Consulta Las Existencias de un Articulo");
