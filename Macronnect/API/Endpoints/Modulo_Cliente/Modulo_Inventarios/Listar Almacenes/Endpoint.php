<?php 
    ...
    // URL Endpoint
    $dataEndpoint = new DataEndpoint("/inventarios/almacenes");

    // Values Endpoint
    $dataEndpoint->setTitle("Listar Almacenes");
    $dataEndpoint->setMethod("GET");
    $dataEndpoint->setVersionAPI(DataConnection::$PATH_VERSION_API_CLIENT);
    $dataEndpoint->setDescription("Este Endpoint Consulta la Lista de Almacenes en el Sistema Macronnect");
