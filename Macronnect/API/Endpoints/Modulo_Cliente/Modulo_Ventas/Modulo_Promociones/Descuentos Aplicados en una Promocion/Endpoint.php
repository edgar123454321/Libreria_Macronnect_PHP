<?php 
    ...
    // URL Endpoint
    $dataEndpoint = new DataEndpoint("/ventas/promociones/__idPromocion__/descuentos");

    // Values Endpoint
    $dataEndpoint->setTitle("Descuentos Aplicados en una Promocion");
    $dataEndpoint->setMethod("GET");
    $dataEndpoint->setVersionAPI(DataConnection::$PATH_VERSION_API_CLIENT);
    $dataEndpoint->setDescription("Este Endpoint Consulta los Descuentos Aplicados en una Promocion");
