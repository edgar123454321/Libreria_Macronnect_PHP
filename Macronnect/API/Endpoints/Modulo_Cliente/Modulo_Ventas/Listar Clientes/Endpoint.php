<?php 
    ...
    // URL Endpoint
    $dataEndpoint = new DataEndpoint("/ventas/clientes");

    // Values Endpoint
    $dataEndpoint->setTitle("Listar Clientes");
    $dataEndpoint->setMethod("GET");
    $dataEndpoint->setVersionAPI(DataConnection::$PATH_VERSION_API_CLIENT);
    $dataEndpoint->setDescription("Este Endpoint Consulta la Lista de Clientes en el Sistema Macronnect");
