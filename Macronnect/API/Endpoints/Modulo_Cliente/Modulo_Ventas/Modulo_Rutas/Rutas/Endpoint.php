<?php 
    ...
    // URL Endpoint
    $dataEndpoint = new DataEndpoint("/ventas/ruta/__idRuta__/");

    // Values Endpoint
    $dataEndpoint->setTitle("Consulta Detalle Ruta");
    $dataEndpoint->setMethod("GET");
    $dataEndpoint->setVersionAPI(DataConnection::$PATH_VERSION_API_CLIENT);
    $dataEndpoint->setDescription("Este Endpoint Consulta el detalle de una Ruta");
